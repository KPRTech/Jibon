...
const CareerPage = () => {
  let [jobsAccordion, setJobsAccordion] = useState([
    {
  ...
  const handleFAQ = (clickIndex) => {
    jobsAccordion.map((item, index) => {
      ...
      setJobsAccordion([...jobsAccordion]);
    });
  };
            ...
            <div className="font-time">
              ...
              <div className="p-4 border-[1px] text-slate-700 leading-7">
                <p>
                  ...
                  Zindagi Trust works on improving the quality of education
                  available to the average Pakistani child through pilot
                  projects in school reform and policy advocacy. It has
                  transformed two government schools in Karachi into model
                  institutions and used the success of its work there to impact
                  thousands of government schools through policy changes in
                  school governance, child protection, etc.
                  <br /> The Trust’s vision for a successful school is one that
                  ...
                  The primary role of the Academic Officer is to ensure that
                  high-quality education interventions are imparted at the
                  ...
                  <ul className="list-disc ml-8 text-sm">
                    <li>
                      Analyze assessments/diagnostic tests of students with the
                      PD team and identify emerging patterns.
                    </li>
                    <li>
                      Identify areas for research which may include
                      understanding the effectiveness of implemented
                      interventions
                    </li>
                    <li>
                      Support in the analysis of teacher improvement data with
                      the PD team and identify prioritized areas of development.
                    </li>
                    <li>
                      Present findings and recommendations for improvement to
                      School Management and HO.
                    </li>
                    <li>
                      Conduct needs analysis sessions with students to
                  ...
                  <ul className="list-disc ml-8 text-sm">
                    <li>
                      Collaborate with external academic stakeholders to
                      implement academic interventions
                    </li>
                    <li>
                      Collaborate with the PD team to identify and involve
                      external partners/trainers as needed for teacher
                      professional development
                    </li>
                    <li>
                      Liaison with government stakeholders to ensure alignment
                  ...
                  <ul className="list-disc ml-8 text-sm">
                    ...
                    <li>
                      Knowledge of the academic field: crucial to have a
                      thorough understanding of the field of education in the
                      context of Pakistan. As well as a familiarity with current
                      trends and best practices in education. This can help you
                      to make informed decisions about curriculum development
                      and other academic matters.
                    </li>
                    <li>
                      Excellent communication skills: The incumbent needs to be
                      able to effectively communicate with a wide range of
                      stakeholders, including students, staff, and external
                      partners. This may involve presenting ideas and
                      information in a clear and concise manner, as well as
                      listening actively and seeking to understand the
                      perspectives of others.
                    </li>
                    <li>
                      {" "}
                      Strong analytical and problem-solving skills: As an
                      academic officer, you will be expected to analyze data and
                      make decisions based on that analysis. You should have
                      strong analytical skills and be able to approach problems
                      in a logical, methodical way.
                    </li>
                    <li>
                      Adaptability: Should be able to adapt to new challenges
                      and circumstances as they arise. You should be able to
                      think on your feet and be comfortable with change and
                      uncertainty.
                    </li>
                    <li>
                      Collaboration and teamwork: As an academic officer, you
                      will often be working with others to achieve shared goals.
                      It is important to be able to collaborate effectively with
                      others and to be a good team player.
                    </li>
                  </ul>
                  <span className="text-xl mb-1 text-primary mt-5 font-semibold flex justify-start gap-x-2 items-center">
                    {" "}
                  ...
                  Prospective candidates should send their CV to
                  career@zindagitrust.org with a cover letter describing how
                  their previous experience fits within this role.
                </p>
              </div>
            </div>
            <div className="font-time">
