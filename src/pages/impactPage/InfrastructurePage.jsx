...
const InfrastructurePage = () => {
  const slidingCards = [
    {
      ...
      firstImageSrc: "assets/images/secondarySliderImage/1.jpg",
      secondImageSrc: "assets/images/secondarySliderImage/2.jpg",
      thirdImageSrc: "assets/images/secondarySliderImage/3.jpg",
      description:
    ...
    {
      title: "CLASSROOMS",
      firstImageSrc: "assets/images/secondarySliderImage/4.jpg",
      secondImageSrc: "assets/images/secondarySliderImage/5.jpg",
      thirdImageSrc: "assets/images/secondarySliderImage/6.jpg",
      description:
    ...
    },
    {
      ...
      firstImageSrc: "assets/images/secondarySliderImage/7.jpg",
      secondImageSrc: "assets/images/secondarySliderImage/8.jpg",
      thirdImageSrc: "assets/images/secondarySliderImage/9.jpg",
      description:
    ...
    },
    {
      ...
      firstImageSrc: "assets/images/secondarySliderImage/10.jpg",
      secondImageSrc: "assets/images/secondarySliderImage/11.jpg",
      thirdImageSrc: "assets/images/secondarySliderImage/10.jpg",
      description:
    ...
    },
    {
      ...
      firstImageSrc: "assets/images/secondarySliderImage/12.jpg",
      secondImageSrc: "assets/images/secondarySliderImage/13.jpg",
      thirdImageSrc: "assets/images/secondarySliderImage/14.jpg",
      description:
    ...
    },
    {
      ...
      firstImageSrc: "assets/images/secondarySliderImage/15.jpg",
      secondImageSrc: "assets/images/secondarySliderImage/16.jpg",
      thirdImageSrc: "assets/images/secondarySliderImage/17.jpg",
      description:
    ...
    },
    {
      ...
      firstImageSrc: "assets/images/secondarySliderImage/18.jpg",
      secondImageSrc: "assets/images/secondarySliderImage/19.jpg",
      thirdImageSrc: "assets/images/secondarySliderImage/20.jpg",
      description:
    ...
    {
      title: "WASHROOMS",
      firstImageSrc: "assets/images/secondarySliderImage/21.jpg",
      secondImageSrc: "assets/images/secondarySliderImage/21.jpg",
  ...
  return (
    <div className="">
      ...
      <div className="w-[80%] mx-auto mt-12 mb-10 grid grid-cols-2 justify-items-center
        ...
        {slidingCards.map((slidingCard) => {
          return (
            <div className="2xl:w-[500px] xl:w-[400px] lg:w-[400px] md:w-[400px] sm:w-[400px] xs:w-[200px] mt-5">
              <h2 className="font-rale text-[#FF6400] text-2xl font-bold">{slidingCard.title}</h2>
              <div className="mt-2 mb-2"><hr /></div>
              <div className="mt-5">
                 <SecondarySlider children={slidingCard} />
              </div>
              <p className="mt-12 font-rale text-slate-700 text-base">{slidingCard.description}</p>
            </div>
          );
        })}
      </div>
