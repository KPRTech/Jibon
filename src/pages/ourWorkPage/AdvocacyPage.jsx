...
const AdvocacyPage = () => {
    ...
    return (
        <div>
            ...
            <PolicyAchievements policy_achievement={policy_achievement} title="POLICY ACHIEVEMENTS" content="We have been successful in bringing about a change in policy and legislation for child protection and school governance due to our efforts in advocacy. Some of our significant policy achievements include:" />
            <CurrentGoals/>
            <MediaGallery/>
