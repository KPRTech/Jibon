        ...
        <div>
                ...
                <div className='max-w-6xl mx-auto'>
                    ...
                    >
                        <div className='text-center text-[17px] font-rale text-[#333] mx-7'>
                            <img className='mb-5' src="assets/images/asiapakistan/apslider1.jpg" alt="" />
                            <h1>Anam Palla</h1>
                            <h1>Educationist & Change Catalyst</h1>
                        </div>
                        <div className='text-center text-[17px] font-rale text-[#333] mx-7'>
                            <img className='mb-5' src="assets/images/asiapakistan/apslider2.png" alt="" />
                            <h1>Shehzad Roy</h1>
                            <h1>Musician & Humanitarian</h1>
                        </div>
                        <div className='text-center text-[17px] font-rale text-[#333] mx-7'>
                            <img className='mb-5' src="assets/images/asiapakistan/apslider3.jpg" alt="" />
                            <h1>Alizah Sethi</h1>
                            <h1>Volunteer and Supporter</h1>
                        </div>
                        <div className='text-center text-[17px] font-rale text-[#333] mx-7'>
                            <img className='mb-5' src="assets/images/asiapakistan/apslider4.jpg" alt="" />
                            <h1>Aisha Qazizada</h1>
                            <h1>Micro-Blogger and Supporter</h1>
                        </div>
                        <div className='text-center text-[17px] font-rale text-[#333] mx-7'>
                            <img className='mb-5' src="assets/images/asiapakistan/apslider5.jpg" alt="" />
                            <h1>Alizeh Hashmi</h1>
                            <h1>Medical Student</h1>
                        </div>
                        <div className='text-center text-[17px] font-rale text-[#333] mx-7'>
                            <img className='mb-5' src="assets/images/asiapakistan/apslider6.jpg" alt="" />
                            <h1>Ebba Qureshi</h1>
                            <h1>Founder and CEO Femgames</h1>
                        </div>
                        <div className='text-center text-[17px] font-rale text-[#333] mx-7'>
                            <img className='mb-5' src="assets/images/asiapakistan/apslider7.jpg" alt="" />
                            <h1>Faizan Lakhani</h1>
                            <h1>Journalist and Sports Reporter</h1>
                        </div>
                        <div className='text-center text-[17px] font-rale text-[#333] mx-7'>
                            <img className='mb-5' src="assets/images/asiapakistan/apslider8.jpg" alt="" />
                            <h1>Rihaab Atta</h1>
                            <h1>Youngest News Anchor (Jinn TV)</h1>
                        </div>
                        <div className='text-center text-[17px] font-rale text-[#333] mx-7'>
                            <img className='mb-5' src="assets/images/asiapakistan/apslider9.jpg" alt="" />
                            <h1>Sabir Shah</h1>
                            <h1>Micro-blogger and supporter</h1>
                        </div>
                        <div className='text-center text-[17px] font-rale text-[#333] mx-7'>
                            <img className='mb-5' src="assets/images/asiapakistan/apslider10.jpg" alt="" />
                            <h1>Salma Alam</h1>
                            <h1>CEO Durbeen</h1>
                        </div>
                        <div className='text-center text-[17px] font-rale text-[#333] mx-7'>
                            <img className='mb-5' src="assets/images/asiapakistan/apslider11.jpg" alt="" />
                            <h1>Shamila Rashid</h1>
                            <h1>Micro-blogger and supporter</h1>
                        </div>
                        <div className='text-center text-[17px] font-rale text-[#333] mx-7'>
                            <img className='mb-5' src="assets/images/asiapakistan/apslider12.jpg" alt="" />
                            <h1>Shireen Ikramullah</h1>
                            <h1>Artist & Teacher</h1>
                        </div>
                        <div className='text-center text-[17px] font-rale text-[#333] mx-7'>
                            <img className='mb-5' src="assets/images/asiapakistan/apslider13.jpg" alt="" />
                            <h1>Tooba Zafar</h1>
                    ...
                    <div className='lg:w-[45%] mx-auto pb-10 mt-[20px]'>
                        <a href="#donate" className='no-underline text-[17px] font-rale text-white'>
            ...
            >
                <div className='max-w-6xl mx-4 md:mx-auto pt-[50px] pb-[100px]'>
                    <h1 className='font-bold font-mont text-[#333] text-left text-[20px]'>How to participate: about the <br />
                        #<span className='font-normal'>Aisa</span>Pakistan campaign</h1>
                    <br />
                    <p className='font-rale text-[18px] text-[#333] leading-[2]'>We believe that holistic education – through art, sports, chess, music and child abuse awareness – can lead to a Pakistan that is progressive, tolerant and prosperous. If you share our vision of <strong>#</strong>Aisa<strong>Pakistan</strong>, your support can help us bring holistic education to our government schools.</p>
                    <br />
                    <img src="assets/images/asiapakistan/ib.png" alt="" />
                    <br />
                    <p className='font-rale text-[18px] text-[#333] leading-[2]'>Please join us for this global day of giving – you can help us in the following 3 ways:</p>
                    <br />
                    <ol className='font-rale text-[17px] text-[#333] list-[lower-roman] lg:pl-[20px] '>
                        <li>Recruit a like-minded friend (or three) and together donate $50 or Rs 5000 through our Facebook Fundraiser, Website or
                            <br /> GlobalGiving page</li>
                        <li>Take a selfie with a handwritten note on what you think should be taught in Pakistan's schools to build #AisaPakistan – the tolerant, progressive and prosperous future of our dreams</li>
                        <li>Share on your social media with our hashtag #AisaPakistan. (e.g. “I want urban gardening programs in school for a kinder, greener and smarter Pakistan. I am supporting @zindagitrust in their quest to build #AisaPakistan through holistic education at government schools this Holiday Season – join the movement!”)
                        </li>
                        <ol>
                            <br />
                            ...
                            <div className='my-[5px] py-[30px] grid md:grid-cols-2 gap-y-5'>
                                <div className='md:border-r-[1px] border-solid border-r-black px-[15px] relative'>
                                    <a href="#/" className=''>
                                        <img className='inline-block align-middle' src="assets/images/asiapakistan/dn-fb.png" alt="" />
                                ...
                                <div className='px-[15px] relative'>
                                    <a href="#/" className=''>
                                        <img className='inline-block align-middle' src="assets/images/asiapakistan/dn-gg.png" alt="" />
                                        <div className='absolute top-0 left-0 right-0 bottom-0 h-full w-full hover:bg-black/50 ease-linear duration-500'></div>
                                    </a>
                                </div>
                            </div>
