...
const BeforeAfterSchoolReform = () => {
    return (
        <div className='relative lg:h-[600px] border overflow-hidden'>
            ...
            <div className='grid lg:grid-cols-2 md:grid-cols-2 gird-cols-1 lg:w-[90%] m-auto text-center p-2'>
                <div>
                    ...
                    <span className='text-md font-bold font-mont'>SMB Fatima Jinnah Government Girls School</span>
                ...
                <div>
                    ...
                    <span className='text-md font-bold font-mont'>Khatoon-e-Pakistan Government Girls School</span>
                    <div className='flex justify-center'>
                        <PrimaryButton children="VIEW ALL BEFORE AND AFTER GALLERY" />
                    </div>
                </div>
