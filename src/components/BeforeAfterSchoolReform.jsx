...
const BeforeAfterSchoolReform = () => {
  return (
    <div className='relative lg:h-[600px] border overflow-hidden'>
        ...
        <AchievementHeader achiveHeader="BEFORE AND AFTER TRANSFORMATION OF SCHOOLS" achiveDescription="Hold and slide right to see the school transform from before to after our intervention" />
        
        <div className='flex justify-center flex-wrap lg:w-[90%] m-auto text-center'>
            <div>
