...
const AchievementHeader = ({achiveHeader,achiveDescription}) => {
    return (
        <div>
            <div className='text-center pt-[30px]'>
                <div className='text-[26px] text-[#333333] uppercase font-bold tracking-[1px] font-mont mb-[10px]'>{achiveHeader}</div>
