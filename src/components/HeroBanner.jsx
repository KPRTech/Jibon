                ...
                <div className='bg-black h-[280px] lg:h-[360px] bg-opacity-[.78]'>
                    <div className='relative z-20'>
                        <div className='text-center pt-[90px] lg:pt-[150px] pb-8'>
                            <div className='text-2xl lg:text-4xl text-white leading-7 font-mont font-medium'>{title}</div>
                            <br />
                            <em className='text-[#999999] text-sm lg:text-base font-play leading-[16px] italic'>{heroTextOne}<br />{heroTextTwo}</em>
                        </div>
                    </div>
                </div>
            </div>
